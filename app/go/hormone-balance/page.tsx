  ...
  return (
    <div className="border-b border-pink-900/30">
      ...
      >
        ...
        <span className="text-pink-500 text-xl ml-4 shrink-0">
          {open ? '−' : '+'}
        </span>
      </button>
      {open && (
      ...
      <section className="bg-gradient-to-b from-pink-50 to-white px-4 pt-8 pb-10 text-center max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-center gap-1 mb-3">
          ...
          <span className="text-gray-500 text-sm ml-1">
            (47 reviews on Amazon)
          </span>
        </div>
        <p className="text-pink-600 text-xs font-semibold uppercase tracking-wider mb-2">
          Ayurvedic Formula for Women
        </p>
        <h1 className="text-3xl font-bold mb-3 leading-tight text-gray-900">
          Your Cycle Shouldn&apos;t
          <br />
          Run Your Life.
        </h1>
        <p className="text-gray-600 text-base mb-6 leading-relaxed">
          6 Ayurvedic herbs that help with PMS, cramps, mood swings, and the
          hormonal chaos of perimenopause — without synthetic hormones.
        </p>
        <a
          href={AMAZON_LINK}
      ...
      <section className="px-4 py-10 bg-pink-50/50">
        <div className="max-w-lg mx-auto">
          ...
          <p className="text-center text-gray-500 text-sm mt-6 italic">
            These aren&apos;t things you just &ldquo;deal with.&rdquo; Your body
      ...
      <section className="px-4 py-10">
        <div className="max-w-lg mx-auto">
          <h2 className="text-xl font-bold text-center mb-2 text-gray-900">
            6 Herbs. Thousands of Years of Use.
          </h2>
          <p className="text-center text-gray-500 text-sm mb-6">
            Concentrated extracts, not weak powders.
          </p>
          <div className="space-y-3">
            {[
              {
                ...
                dose: '3,000mg equiv.',
                icon: '🌸',
                desc: 'The "Queen of Herbs" in Ayurveda. Used for centuries to nourish the female reproductive system, ease PMS, and support hormonal transitions.',
              },
              {
                name: 'Ashwagandha',
                dose: '3,000mg equiv.',
                icon: '🧘‍♀️',
                desc: 'Regulates cortisol — the stress hormone that makes everything worse. Calms anxiety, improves sleep, stabilizes mood.',
              },
              {
                name: 'Tribulus Terrestris',
                dose: '500mg equiv.',
                icon: '⚡',
                desc: 'Supports natural hormone production. Helps with energy and libido that hormonal imbalance steals from you.',
              },
              {
                name: 'Ashoka',
                dose: '500mg equiv.',
                icon: '🩸',
                desc: 'Named after "freedom from sorrow." Traditionally used for heavy periods, cramps, and uterine health.',
              },
              {
                name: 'Lodhra',
                dose: '100mg equiv.',
                icon: '💮',
                desc: 'Helps regulate menstrual cycles and supports reproductive tissue health.',
              },
              {
                name: 'Guduchi',
                dose: 'Supportive',
                icon: '🛡️',
                desc: 'The "root of immortality." Immune support and detox while your body rebalances.',
              },
            ].map((herb) => (
              <div
                key={herb.name}
                className="bg-pink-50 rounded-xl p-4 flex gap-3"
              >
                <span className="text-2xl">{herb.icon}</span>
                <div>
                  <div className="flex items-baseline gap-2 flex-wrap">
                    <span className="font-bold text-gray-900">{herb.name}</span>
                    <span className="text-pink-600 text-xs font-mono bg-pink-100 px-1.5 py-0.5 rounded">
                      {herb.dose}
                    </span>
                  </div>
      ...
      <section className="px-4 py-10 bg-pink-50/50">
        <div className="max-w-lg mx-auto text-center">
          ...
          <div className="space-y-4">
            {[
              {
                text: '"My PMS used to be unbearable — bloating, cramps, mood swings. After 3 weeks on this, my last cycle was the easiest I\'ve had in years."',
                stars: 5,
                name: 'Sarah K.',
              },
              {
                text: '"I\'m 48 and in perimenopause. The hot flashes have calmed down significantly. I actually sleep through the night now."',
                stars: 5,
                name: 'Maria L.',
              },
              {
                text: '"Clean ingredients, no side effects. I feel more balanced and less irritable. My husband noticed before I did."',
                stars: 4,
                name: 'Jennifer R.',
              },
            ].map((review, i) => (
      ...
      <section className="px-4 py-12 text-center">
        <div className="max-w-lg mx-auto">
          <p className="text-pink-600 font-bold text-lg mb-1">
            $29.95 · 2-Month Supply
          </p>
          <h2 className="text-2xl font-bold mb-2 text-gray-900">
            Stop Surviving Your Cycle.
            <br />
            Start Living Through It.
          </h2>
          <p className="text-gray-500 text-sm mb-6">
            Join 50,000+ women who trust Pure Prana.
          </p>
          <a
            href={AMAZON_LINK}
            className="inline-block bg-pink-600 hover:bg-pink-500 text-white font-bold py-3.5 px-8 rounded-full text-lg transition-colors shadow-lg shadow-pink-200"
          ...
          <p className="text-gray-400 text-xs mt-3">
            Free Prime shipping · 60-day supply · GMP certified
          </p>
        </div>
      </section>
