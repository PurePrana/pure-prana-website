    ...
    <div className="min-h-screen bg-stone-50 text-stone-800 pb-24">
      ...
      <section className="bg-gradient-to-b from-purple-50 to-stone-50 px-5 pt-12 pb-10">
        <div className="max-w-xl mx-auto text-center">
          <p className="text-sm uppercase tracking-widest text-purple-600 mb-3">For women in perimenopause & menopause</p>
          <h1 className="text-3xl md:text-4xl font-serif font-bold leading-tight text-stone-900 mb-4">
            Your Doctor Said &ldquo;Wait It Out.&rdquo;<br />
            <span className="text-purple-700">We Say You Deserve Better.</span>
          </h1>
          <p className="text-lg text-stone-600 leading-relaxed mb-6">
            You&rsquo;re not imagining the hot flashes at 3am. The brain fog that makes you feel like a stranger in your own mind. The fatigue that no amount of sleep fixes. <strong>You&rsquo;re not crazy. You&rsquo;re in perimenopause.</strong> And you deserve more than &ldquo;just wait.&rdquo;
          </p>
      ...
      <section className="px-5 py-10">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-serif font-bold text-center mb-6">We See You.</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex gap-3 items-start bg-white p-4 rounded-xl shadow-sm border border-purple-100">
          ...
          <p className="text-center text-stone-600 mt-6 text-lg italic">
            &ldquo;I don&rsquo;t know if I have the emotional strength to see this through.&rdquo;<br />
            <span className="text-sm not-italic">— Real words from a real woman in perimenopause</span>
          </p>
        </div>
      </section>
      ...
      <section className="px-5 py-10 bg-white">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-2xl font-serif font-bold mb-2">There Is Another Way.</h2>
          <p className="text-stone-600 mb-6">
            Not another doctor telling you to &ldquo;wait it out.&rdquo; Not a random supplement someone mentioned in passing. This is a carefully formulated blend of 6 Ayurvedic herbs — backed by centuries of traditional use and modern research — designed specifically for hormonal balance during perimenopause.
          </p>
          ...
          <h3 className="text-xl font-bold mb-1">Pure Prana Hormonal Balance</h3>
          <p className="text-stone-500 text-sm mb-3">60 Capsules · 30-Day Supply</p>
          <Stars rating={4.6} count={47} />
        </div>
      </section>
      ...
      <section className="px-5 py-10">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-serif font-bold text-center mb-8">What Women Are Feeling</h2>
          <div className="grid gap-4">
            {[
              { icon: '🌙', title: 'Better Sleep', desc: 'Fewer night sweats, more restful nights. Ashwagandha helps regulate cortisol — the stress hormone that wakes you at 3am.' },
              { icon: '🧊', title: 'Hot Flash Relief', desc: 'Shatavari supports estrogen balance naturally, helping reduce the frequency and intensity of hot flashes.' },
              { icon: '🧠', title: 'Mental Clarity', desc: 'The "brain fog" isn\'t in your head. Adaptogens like Ashwagandha help restore focus and cognitive sharpness.' },
              { icon: '⚡', title: 'Real Energy', desc: 'Not a caffeine spike — genuine, sustained vitality. Guduchi and Ashwagandha support your body\'s natural energy systems.' },
              { icon: '💛', title: 'Mood Stability', desc: 'Fewer emotional rollercoasters. Ashoka and Shatavari have been used for centuries to support women\'s emotional wellbeing.' },
              { icon: '🔥', title: 'Libido Support', desc: 'Tribulus Terrestris is traditionally used to support healthy desire and intimate wellness.' },
            ].map((b, i) => (
              <div key={i} className="bg-white p-5 rounded-xl shadow-sm border border-stone-100">
      ...
      <section className="px-5 py-10 bg-purple-50">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-serif font-bold text-center mb-2">6 Herbs, One Purpose</h2>
          <p className="text-center text-stone-600 mb-8">Traditional Ayurvedic wisdom meets modern formulation</p>
          <div className="space-y-3">
            {[
              { name: 'Shatavari', amount: '3,000mg equiv.', role: 'The "queen of herbs" for women — supports estrogen balance and reproductive health' },
              { name: 'Ashwagandha', amount: '3,000mg equiv.', role: 'Adaptogen powerhouse — regulates cortisol, reduces hot flashes, improves sleep' },
              { name: 'Tribulus Terrestris', amount: '500mg', role: 'Supports healthy libido and vitality' },
              { name: 'Ashoka', amount: '500mg', role: 'Named after "freedom from sorrow" — traditional support for mood and cycle regulation' },
              { name: 'Lodhra', amount: '100mg', role: 'Hormonal balance and reproductive wellness' },
              { name: 'Guduchi', amount: 'Included', role: 'Immune support and cellular rejuvenation' },
            ].map((herb, i) => (
              <div key={i} className="bg-white p-4 rounded-xl">
                <div className="flex justify-between items-center mb-1">
                  <span className="font-bold text-purple-800">{herb.name}</span>
                  <span className="text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded-full">{herb.amount}</span>
                </div>
      ...
      <section className="px-5 py-10">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-serif font-bold text-center mb-6">Common Questions</h2>
          <div className="space-y-3">
            {faqs.map((faq, i) => (
      ...
      <section className="px-5 py-10 bg-gradient-to-b from-purple-50 to-stone-50 text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-serif font-bold mb-3">You&rsquo;ve Waited Long Enough.</h2>
          <p className="text-stone-600 mb-6">You deserve to feel like yourself again. Try Pure Prana Hormonal Balance risk-free.</p>
          <Link
            href={AMAZON_URL}
            target="_blank"
