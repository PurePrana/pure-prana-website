...
const herbs = [
  {
    ...
    target: 'Cortisol & Stress',
    desc: 'The #1 adaptogen for stress. Regulates cortisol — the hormone behind hot flashes, insomnia, and that wired-but-tired feeling. Clinically shown to reduce anxiety and improve sleep quality.',
  },
  {
    name: 'Shatavari',
    amount: '3,000mg equiv.',
    target: 'Estrogen Support',
    desc: 'Known as the "queen of herbs" in Ayurveda. Contains phytoestrogens that gently support declining estrogen levels — helping with dryness, mood, and overall hormonal balance.',
  },
  {
    name: 'Tribulus Terrestris',
    amount: '500mg',
    target: 'Libido & Vitality',
    desc: 'Traditionally used to support sexual health and desire. Helps restore the spark that perimenopause can dim.',
  },
  {
    name: 'Ashoka',
    amount: '500mg',
    target: 'Mood & Cycle',
    desc: 'Its name literally means "without sorrow." Used for centuries to support emotional balance and healthy menstrual function during the transition.',
  },
  {
    name: 'Lodhra',
    amount: '100mg',
    target: 'Hormonal Balance',
    desc: 'A lesser-known but powerful herb for reproductive health and hormonal regulation.',
  },
  {
    name: 'Guduchi',
    amount: 'Included',
    target: 'Immune & Rejuvenation',
    desc: 'Called "the one who protects the body." Supports immune function and cellular health during a time when your body needs extra support.',
  },
]
    ...
    <div className="min-h-screen bg-stone-50 text-stone-800 pb-24">
      ...
      <section className="bg-gradient-to-b from-amber-50 via-purple-50 to-stone-50 px-5 pt-12 pb-10">
        <div className="max-w-xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif font-bold leading-tight text-stone-900 mb-4">
            ...
            <br />
            Brain Fog. <span className="text-purple-700">Sound Familiar?</span>
          </h1>
          <p className="text-lg text-stone-600 leading-relaxed">
            Check the symptoms you&rsquo;re experiencing. Then see exactly which
            herbs address each one.
          </p>
        </div>
      </section>
      ...
      <section className="px-5 py-8">
        <div className="max-w-xl mx-auto">
          <h2 className="text-xl font-serif font-bold text-center mb-5">
          ...
          {checkedCount >= 3 && (
            <div className="mt-6 text-center p-4 bg-purple-50 rounded-xl border border-purple-200">
              <p className="text-purple-800 font-medium">
                You checked {checkedCount} out of {symptoms.length}.{' '}
                {checkedCount >= 6
                  ? "You're not alone — and you're not imagining it."
                  : 'These are real perimenopause symptoms.'}
              </p>
              <p className="text-purple-600 text-sm mt-1">
                Keep reading — there&rsquo;s a reason this is happening, and
                there&rsquo;s something you can do.
              </p>
            </div>
          )}
        </div>
      ...
      <section className="px-5 py-10 bg-white">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-serif font-bold text-center mb-3">
            Here&rsquo;s What&rsquo;s Actually Happening
          </h2>
          <div className="text-stone-600 space-y-3 mb-8">
            <p>
              During perimenopause, your estrogen and progesterone don&rsquo;t
              just decline — they <strong>fluctuate wildly</strong>. One week
              you have too much estrogen, the next not enough. Meanwhile,
              cortisol (your stress hormone) stays elevated because your body
              perceives the hormonal chaos as a threat.
            </p>
            <p>
              The result? Hot flashes. Insomnia. Brain fog. Mood swings. Weight
              gain. Low libido. Joint pain. It&rsquo;s not one symptom —
              it&rsquo;s a cascade.
            </p>
            <p className="font-medium text-stone-800">
              You need something that addresses the whole system. Not just one
              symptom.
            </p>
          </div>
          ...
          <div className="text-center mb-2">
            ...
            <p className="text-stone-500 text-sm mb-2">
              60 Capsules · 30-Day Supply · $29.95
            </p>
      ...
      <section className="px-5 py-10 bg-gradient-to-b from-purple-50 to-stone-50">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl font-serif font-bold text-center mb-2">
            6 Herbs That Address It
          </h2>
          <p className="text-center text-stone-600 mb-8">
            Each one targets a different piece of the perimenopause puzzle
          </p>
          <div className="space-y-4">
            {herbs.map((herb, i) => (
              <div
                key={i}
                className="bg-white p-5 rounded-xl shadow-sm border border-purple-100"
              >
      ...
      <section className="px-5 py-10 bg-gradient-to-b from-purple-50 to-stone-50 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-stone-600 mb-6">
            Your body is asking for support. 6 herbs. 1 capsule. A real path
            forward.
          </p>
          <Link
            href={AMAZON_URL}
