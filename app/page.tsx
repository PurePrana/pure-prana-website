...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-primary-50 to-white">
      ...
      <section id="research" className="notion-page bg-gradient-to-b from-white to-primary-50/30">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-brand-600 tracking-wider uppercase">Our Process</span>
            <h2 className="heading-2 mt-4 mb-6">
              Rigorous Three-Stage Validation
            </h2>
            <p className="text-body-large text-muted max-w-2xl mx-auto">
              Every Pure Prana formula undergoes extensive validation, bridging ancient wisdom with modern scientific standards
            </p>
          </div>
          ...
          <div className="grid gap-6">
            <div className="group relative bg-white rounded-2xl border border-primary-200 p-8 hover:border-primary-300 hover:shadow-lg transition-all duration-300">
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  <h3 className="heading-4 mb-3 text-primary-900">Literature Review</h3>
                  <p className="text-body text-muted leading-relaxed">
                    Our research team analyzes both ancient Ayurvedic texts and contemporary peer-reviewed studies. 
                    Led by PhDs in pharmacology and traditional medicine, we ensure every formula has strong theoretical foundation.
                  </p>
            ...
            <div className="group relative bg-white rounded-2xl border border-primary-200 p-8 hover:border-primary-300 hover:shadow-lg transition-all duration-300">
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  <h3 className="heading-4 mb-3 text-primary-900">Laboratory Analysis</h3>
                  <p className="text-body text-muted leading-relaxed">
                    Every batch undergoes comprehensive testing in our FDA-registered facility: HPLC for purity, 
                    heavy metal screening, microbial analysis, and potency verification to pharmaceutical standards.
                  </p>
                  <div className="mt-4 flex items-center gap-4">
                    <span className="text-sm text-brand-600 font-medium">98%+ purity standard</span>
                    <span className="w-1 h-1 bg-primary-300 rounded-full"></span>
                    <span className="text-sm text-brand-600 font-medium">12 quality checkpoints</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 relative bg-gradient-to-r from-primary-100 to-brand-100 rounded-2xl p-8 overflow-hidden">
            ...
            <div className="relative z-10 flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm">
                <svg className="w-6 h-6 text-brand-700" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10 2a1 1 0 011 1v1.323l3.954 1.582 1.599-.8a1 1 0 01.894 1.79l-1.233.616 1.738 5.42a1 1 0 01-.285 1.05A3.989 3.989 0 0115 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.715-5.349L11 6.477V16h2a1 1 0 110 2H7a1 1 0 110-2h2V6.477L6.237 7.582l1.715 5.349a1 1 0 01-.285 1.05A3.989 3.989 0 015 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.738-5.42-1.233-.617a1 1 0 01.894-1.788l1.599.799L9 4.323V3a1 1 0 011-1z"/>
                </svg>
              </div>
              <div className="flex-1">
                <h4 className="text-lg font-semibold text-primary-900 mb-2">Made in USA</h4>
                <p className="text-body text-primary-700">
                  All Pure Prana products are manufactured in our GMP-certified, FDA-registered facility in California, 
                  ensuring pharmaceutical-grade quality standards and complete supply chain transparency.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="products" className="py-24 bg-gradient-to-b from-white via-primary-50/30 to-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 animate-fade-in">
            <span className="text-sm font-medium text-brand-600 tracking-wider uppercase">Our Products</span>
            <h2 className="heading-2 mt-4 mb-6">
              Formulas That Transform Lives
            </h2>
            <p className="text-body-large text-muted max-w-2xl mx-auto">
              Each product represents years of research, combining ancient Ayurvedic wisdom 
      ...
      <section id="testimonials" className="notion-page bg-gradient-to-b from-primary-50/50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-brand-600 tracking-wider uppercase">Real Stories</span>
            <h2 className="heading-2 mt-4 mb-6">
              Trusted by Thousands
            </h2>
            <p className="text-body-large text-muted max-w-2xl mx-auto">
              Join our community of wellness seekers who have discovered the transformative power of authentic Ayurveda
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 pt-8 border-t border-primary-200">
            <div className="text-center">
              <p className="text-3xl font-light text-primary-800 mb-1">50,000+</p>
            ...
            <div className="text-center">
              <p className="text-3xl font-light text-primary-800 mb-1">60-Day</p>
      ...
      <section id="why-ayurveda" className="py-24 bg-gradient-to-b from-white to-primary-50/50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <span className="text-sm font-medium text-brand-600 tracking-wider uppercase">The Science</span>
            <h2 className="heading-2 mt-4 mb-6">
              Why Ayurveda Works
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 group animate-fade-in" style={{animationDelay: '0.1s'}}>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 group animate-fade-in" style={{animationDelay: '0.2s'}}>
              <div className="w-16 h-16 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-primary-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                </svg>
              </div>
              <h3 className="heading-4 mb-4 text-primary-900">Bioactive Compounds</h3>
              <p className="text-body text-muted mb-4">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 group animate-fade-in" style={{animationDelay: '0.3s'}}>
              <div className="w-16 h-16 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-primary-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative bg-gradient-to-br from-primary-100 via-brand-100 to-primary-100 rounded-3xl p-10 overflow-hidden animate-fade-in" style={{animationDelay: '0.4s'}}>
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center">
              ...
              <h3 className="text-2xl font-medium text-primary-900 mb-4">The Holistic Advantage</h3>
              <p className="text-lg text-primary-700 leading-relaxed">
                Unlike conventional medicine that treats symptoms, Ayurveda addresses root causes through 
                a comprehensive understanding of mind, body, and spirit. This integrated approach leads to 
      ...
      <section className="relative py-32 bg-gradient-to-br from-primary-900 via-primary-800 to-brand-900 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand-700/30 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto animate-fade-in" style={{animationDelay: '0.1s'}}>
            Join thousands who have discovered the perfect balance of ancient wisdom and modern science
          </p>
          ...
          <div className="mt-16 pt-16 border-t border-white/20 animate-fade-in" style={{animationDelay: '0.3s'}}>
            <p className="text-white/60 text-sm mb-4">Trusted by healthcare professionals worldwide</p>
            <div className="flex items-center justify-center gap-8">
              ...
              <div className="text-white/80">
                <svg className="w-8 h-8 mx-auto mb-2" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <path fillRule="evenodd" d="M4 5a2 2 0 012-2 1 1 0 000 2H6a2 2 0 00-2 2v6a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-1a1 1 0 100-2 2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2V5z" clipRule="evenodd" />
                </svg>
