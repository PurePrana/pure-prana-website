            ...
            <div>
              ...
              <div className="mt-12 p-6 bg-primary-50 rounded-lg">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/faq" className="text-primary-700 hover:text-primary-900 transition-colors">
                      → Frequently Asked Questions
                    </Link>
                  </li>
                  <li>
                    <Link href="/shipping" className="text-primary-700 hover:text-primary-900 transition-colors">
                      → Shipping & Returns
                    </Link>
                  </li>
                  <li>
                    <Link href="/blog" className="text-primary-700 hover:text-primary-900 transition-colors">
                      → Research & Articles
                    </Link>
                  </li>
                </ul>
