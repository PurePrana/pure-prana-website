...
export default function StartPage() {
  ...
  const [spinResult, setSpinResult] = useState<(typeof WHEEL_PRIZES)[0] | null>(
    null
  )
  ...
  const handleSpinWheel = useCallback(async () => {
    ...
    const targetRotation =
      spins * 360 + (360 - prize.rotation) + (Math.random() * 40 - 20)
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-primary-50 to-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden animate-slide-up">
            ...
            <div className="p-6">
              <form
                onSubmit={(e) =>
                  handleSubmit(e, undefined, undefined, 'qr-landing-modal')
                }
                className="space-y-4"
              >
                <div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden animate-slide-up">
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Get 15% off your first order - we&apos;d hate for you to miss
                out!
              </p>

              <form
                onSubmit={(e) =>
                  handleSubmit(e, undefined, undefined, 'qr-landing-exit')
                }
                className="space-y-4"
              >
                <input
        ...
        <div className="fixed bottom-24 left-4 z-40 flex items-center gap-3 px-4 py-3 bg-white rounded-xl shadow-lg border border-primary-100 animate-slide-up max-w-xs">
          ...
          <div>
            <p className="text-sm font-medium text-primary-900">
              {RECENT_SIGNUPS[currentSignup].name} from{' '}
              {RECENT_SIGNUPS[currentSignup].location}
            </p>
            <p className="text-xs text-gray-500">
              Just claimed their discount!
            </p>
          </div>
        </div>
      )}
        ...
        <div className="relative z-10 max-w-lg mx-auto text-center">
          ...
          {!hasSubmitted && (
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20">
              ...
              <form
                onSubmit={(e) =>
                  handleSubmit(e, undefined, undefined, 'qr-landing-hero')
                }
          ...
          {hasSubmitted && (
            <div className="bg-green-500/20 backdrop-blur-md rounded-2xl p-4 border border-green-400/30">
              ...
              <p className="text-white text-sm mt-1">
                Use code{' '}
                <span className="font-mono font-bold">{discountCode}</span> at
                checkout
              </p>
            </div>
          )}
      ...
      {!hasSubmitted && (
        <section
          ref={progressRef}
          className="py-6 px-4 bg-gradient-to-r from-yellow-50 to-primary-50"
        >
          <div className="max-w-lg mx-auto">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-yellow-200">
              ...
              <form
                onSubmit={(e) =>
                  handleSubmit(e, undefined, undefined, 'qr-landing-progress')
                }
                className="flex flex-col sm:flex-row gap-2"
              >
                <input
      ...
      <section className="py-10 px-4 bg-gradient-to-br from-primary-800 to-primary-900 text-white">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-primary-100 mb-6 leading-relaxed">
            Subscribe for exclusive offers, wellness tips, and a 15% discount
            code.
          </p>
          ...
          {!hasSubmitted ? (
            <form
              onSubmit={(e) =>
                handleSubmit(e, undefined, undefined, 'qr-landing-footer')
              }
              className="space-y-4"
            >
              <input
      ...
      <section className="py-6 px-4 bg-white border-t border-primary-100 sticky bottom-0 z-30 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <div className="max-w-lg mx-auto">
          ...
          >
            ...
            {hasSubmitted && discountCode
              ? `Shop Now - Use Code ${discountCode}`
              : 'Shop Now on Amazon'}
          </Link>
        </div>
      </section>
