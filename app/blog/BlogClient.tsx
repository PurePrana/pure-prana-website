...
export default function BlogClient({ posts, allPosts, featuredPosts, currentPage, totalPages }: BlogClientProps) {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubscriptionMessage({ type: 'success', text: 'Successfully subscribed! Check your email for confirmation.' })
        setNewsletterEmail('')
      } else {
        setSubscriptionMessage({ type: 'error', text: data.error || 'Failed to subscribe. Please try again.' })
      }
    } catch (error) {
      console.error('Subscription error:', error)
      setSubscriptionMessage({ type: 'error', text: 'Network error. Please check your connection and try again.' })
    } finally {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gradient-to-b from-white to-primary-50/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-light text-primary-900 mb-4">Our Research Standards</h2>
            <p className="text-lg text-primary-700 max-w-2xl mx-auto">
              Every piece of content undergoes rigorous review to ensure accuracy and value
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-medium text-primary-900 mb-2">Fact-Checked</h3>
              <p className="text-sm text-primary-600">Every claim verified against scientific literature</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-medium text-primary-900 mb-2">150+ Studies</h3>
              <p className="text-sm text-primary-600">Referenced from peer-reviewed journals</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-medium text-primary-900 mb-2">Expert Review</h3>
              <p className="text-sm text-primary-600">Medical advisory board approval</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-medium text-primary-900 mb-2">Updated Monthly</h3>
              <p className="text-sm text-primary-600">Latest research incorporated regularly</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {featuredPosts.length > 0 && (
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-primary-900 mb-4">Featured Research</h2>
              <p className="text-lg text-primary-700">Our most impactful evidence-based articles</p>
            </div>
            
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {featuredPosts.map((post, index) => (
                <article key={post.slug} className={`${index === 0 ? 'md:col-span-3' : ''}`}>
      ...
      <section className="py-20 bg-gradient-to-b from-primary-50/30 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            <div className="mb-12">
              <h2 className="text-3xl font-light text-primary-900 mb-4">All Articles</h2>
            ...
            {posts.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <Link href="/" className="inline-flex items-center justify-center px-6 py-3 bg-primary-800 text-white font-medium rounded-lg hover:bg-primary-900 transition-colors">
                  Back to Homepage
                </Link>
              </div>
            )}
      ...
      <section className="py-20 bg-gradient-to-br from-primary-900 to-primary-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Join our community of wellness seekers. Get monthly research summaries and 
            expert-reviewed articles delivered to your inbox.
          </p>
          ...
          {subscriptionMessage && (
            <div className={`mt-4 p-3 rounded-lg text-sm ${subscriptionMessage.type === 'success' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'} max-w-md mx-auto`}>
