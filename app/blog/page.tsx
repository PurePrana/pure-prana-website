...
export const metadata = {
  title: 'Research & Insights - Pure Prana',
  description: 'Evidence-based articles on Ayurvedic medicine, clinical studies, and wellness research from Pure Prana\'s expert team.',
}
      ...
      <section className="py-20 bg-gradient-to-br from-primary-900 to-primary-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-white text-primary-800 font-medium rounded-lg hover:bg-primary-50 transition-colors"
            >
              Subscribe
            </button>
          </form>
