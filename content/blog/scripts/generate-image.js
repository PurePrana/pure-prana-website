...
const imagesDir = resolve(projectRoot, 'mcp-servers/dalle-image/generated-images/');
console.log(`📁 Images will be saved to: ${imagesDir}`);
if (options.filename) {
  console.log(`📝 Custom filename: ${options.filename}.png`);
}
console.log(`📐 Size: ${options.size}, Quality: ${options.quality}, Style: ${options.style}\n`);

// Path to MCP server
const serverPath = resolve(projectRoot, 'mcp-servers/dalle-image/build/index.js');
