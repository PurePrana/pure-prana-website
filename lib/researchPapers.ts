...
export const researchPapers: ResearchPaper[] = [
  // Ashwagandha Studies
  {
    ...
    year: 2012,
    summary: 'This landmark study investigated the stress-relieving effects of Ashwagandha (Withania somnifera) root extract in adults with chronic stress. Participants received 300mg of high-concentration extract twice daily for 60 days.',
    keyFindings: [
  ...
  },
  {
    ...
    year: 2014,
    summary: 'A comprehensive systematic review analyzing human clinical trials on Ashwagandha for anxiety treatment. The review included five randomized controlled trials with a total of 400+ participants.',
    keyFindings: [
  ...
  {
    id: '3',
    title: 'Body Weight Management in Adults Under Chronic Stress Through Treatment With Ashwagandha Root Extract',
    authors: 'Choudhary D, Bhattacharyya S, Joshi K',
    journal: 'Journal of Evidence-Based Complementary & Alternative Medicine',
    year: 2017,
    summary: 'This study examined the effects of Ashwagandha root extract on body weight, food cravings, and cortisol levels in adults experiencing chronic stress.',
    keyFindings: [
  ...
  // Bacopa Studies
  {
    ...
    year: 2014,
    summary: 'A meta-analysis examining the cognitive-enhancing effects of Bacopa monnieri across nine randomized controlled trials with 518 participants.',
    keyFindings: [
  ...
  {
    id: '5',
    title: 'Effects of 12-Week Bacopa monnieri Consumption on Attention, Cognitive Processing, Working Memory, and Functions of Both Cholinergic and Monoaminergic Systems in Healthy Elderly Volunteers',
    authors: 'Peth-Nui T, Wattanathorn J, Muchimapura S',
    journal: 'Evidence-Based Complementary and Alternative Medicine',
    year: 2012,
    summary: 'A clinical trial studying the cognitive and neurochemical effects of Bacopa monnieri in healthy elderly participants over 12 weeks.',
    keyFindings: [
  ...
  // Turmeric/Curcumin Studies
  {
    ...
    year: 2016,
    summary: 'A systematic review and meta-analysis evaluating the efficacy of turmeric extracts and curcumin for arthritis symptom relief across 8 randomized controlled trials.',
    keyFindings: [
  ...
  },
  {
    ...
    journal: 'Foods',
    year: 2017,
    summary: 'A comprehensive review of curcumin research covering its anti-inflammatory, antioxidant, and therapeutic properties based on extensive clinical evidence.',
    keyFindings: [
  ...
  // Shilajit Studies
  {
    ...
    journal: 'Andrologia',
    year: 2016,
    summary: 'A randomized, double-blind, placebo-controlled study evaluating the effects of purified Shilajit on testosterone levels in healthy male volunteers aged 45-55 years.',
    keyFindings: [
  ...
  },
  {
    ...
    year: 2012,
    summary: 'A review examining the cognitive-enhancing potential of Shilajit and its active component fulvic acid, with implications for neuroprotection.',
    keyFindings: [
  ...
  // Elderberry Studies
  {
    ...
    year: 2004,
    summary: 'A randomized, double-blind, placebo-controlled study examining the effects of elderberry extract (Sambucus nigra) on influenza symptoms in 60 patients.',
    keyFindings: [
  ...
  {
    id: '11',
    title: 'Black Elderberry (Sambucus nigra) Supplementation Effectively Treats Upper Respiratory Symptoms: A Meta-Analysis',
    authors: 'Hawkins J, Baker C, Cherry L, Dunne E',
    journal: 'Complementary Therapies in Medicine',
    year: 2019,
    summary: 'A meta-analysis of four randomized controlled trials examining elderberry supplementation for upper respiratory symptoms.',
    keyFindings: [
  ...
  // Boswellia Studies
  {
    ...
    year: 2003,
    summary: 'A randomized, double-blind, placebo-controlled crossover study evaluating Boswellia serrata extract in 30 patients with knee osteoarthritis.',
    keyFindings: [
  ...
  {
    id: '13',
    title: '5-Loxin and Aflapin: Novel Boswellia serrata Extracts in Osteoarthritis Management',
    authors: 'Sengupta K, Alluri KV, Satish AR',
    journal: 'Arthritis Research & Therapy',
    year: 2008,
    summary: 'A double-blind, randomized, placebo-controlled study evaluating specialized Boswellia extracts in patients with osteoarthritis of the knee.',
    keyFindings: [
  ...
  {
    id: '14',
    title: 'Terminalia arjuna: A Review on Its Traditional Uses, Phytochemistry and Pharmacology',
    authors: 'Dwivedi S, Chopra D',
    journal: 'Journal of Traditional and Complementary Medicine',
    year: 2014,
    summary: 'A comprehensive review of Terminalia arjuna covering its traditional uses in Ayurveda and modern scientific validation for cardiovascular health.',
    keyFindings: [
  ...
  {
    id: '15',
    title: 'Effect of Terminalia arjuna on Blood Pressure and Arterial Stiffness',
    authors: 'Kapoor D, Vijayvergiya R, Dhawan V',
    journal: 'International Journal of Cardiology',
    year: 2015,
    summary: 'A clinical study investigating the effects of Arjuna bark extract on blood pressure and arterial stiffness in patients with coronary artery disease.',
    keyFindings: [
  ...
  {
    id: '16',
    title: 'Antioxidant Activity and Cardioprotective Effect of Terminalia arjuna',
    authors: 'Karthikeyan K, Bai BR, Devaraj SN',
    journal: 'Molecular and Cellular Biochemistry',
    year: 2007,
    summary: 'A study examining the antioxidant mechanisms and cardioprotective effects of Terminalia arjuna in an experimental model.',
    keyFindings: [
  ...
  // Additional Studies
  {
    ...
    year: 2019,
    summary: 'A randomized, double-blind study examining the stress-relieving and adaptogenic properties of Ashwagandha in 60 healthy adults over 60 days.',
    keyFindings: [
  ...
  },
  {
    ...
    year: 2002,
    summary: 'A double-blind, placebo-controlled study investigating the effects of Bacopa monnieri on memory and cognitive function in healthy older adults.',
    keyFindings: [
...
export function getResearchPapersByIngredient(ingredient: string): ResearchPaper[] {
  return researchPapers.filter(paper =>
    paper.relatedIngredients.some(ing =>
