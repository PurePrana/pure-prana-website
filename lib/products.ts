...
export const products: Product[] = [
  {
    ...
    tags: ['hormone-balance', 'wellness', 'ayurveda', 'womens-health', 'pms', 'menstrual'],
    benefits: [
    ...
    supplementFacts: {
      ...
      ingredients: [
        { name: 'Shatavari (Asparagus racemosus) 10:1 Extract', amount: '300 mg' },
        { name: 'Ashwagandha (Withania somnifera) 20:1 Extract', amount: '150 mg' },
        { name: 'Tribulus Terrestris (Gokshura) 10:1 Extract', amount: '100 mg' },
  ...
  },
  {
    ...
    tags: ['shilajit', 'ashwagandha', 'gokshura', 'energy', 'vitality', 'mens-health', 'brain'],
    benefits: [
    ...
    supplementFacts: {
      ...
      servingsPerContainer: 60,
      ingredients: [
        { name: 'Shilajit (Asphaltum punjabianum) 20:1 Extract', amount: '300 mg' },
        { name: 'Ashwagandha (Withania somnifera) 20:1 Extract', amount: '150 mg' },
        { name: 'Gokshura (Tribulus terrestris) 10:1 Extract', amount: '150 mg' },
        { name: 'Kaunch Beej (Mucuna pruriens) 10:1 Extract', amount: '100 mg' },
        { name: 'Safed Musli (Chlorophytum borivilianum) 10:1 Extract', amount: '100 mg' },
      ],
    },
  },
  {
    ...
    tags: ['bacopa', 'brahmi', 'ashwagandha', 'memory', 'focus', 'clarity', 'nootropic', 'brain'],
    benefits: [
    ...
    supplementFacts: {
      ...
      ingredients: [
        ...
        { name: 'Shankhpushpi (Convolvulus prostratus) 20:1 Extract', amount: '250 mg' },
        { name: 'Jatamansi (Nardostachys jatamansi) 20:1 Extract', amount: '250 mg' },
        { name: 'Ashwagandha (Withania somnifera) 10:1 Extract', amount: '250 mg' },
  ...
  },
  {
    ...
    tags: ['arjuna', 'hawthorn', 'heart', 'circulation', 'blood-pressure', 'cardiovascular'],
    benefits: [
  ...
  },
  {
    ...
    tags: ['elderberry', 'giloy', 'guduchi', 'immunity', 'tulsi', 'neem', 'respiratory'],
    benefits: [
  ...
  },
  {
    ...
    tags: ['glutathione', 'collagen', 'skin', 'hair', 'nails', 'beauty', 'anti-aging', 'brightening'],
    benefits: [
  ...
  },
  {
    ...
    tags: ['green-tea', 'garcinia', 'weight', 'metabolism', 'berberine', 'fat-burn'],
    benefits: [
    ...
    supplementFacts: {
      ...
      ingredients: [
        ...
        { name: 'Berberine (roots, stem & leaves) 10:1 Extract', amount: '100 mg' },
  ...
  },
  {
    ...
    tags: ['boswellia', 'turmeric', 'joint', 'flexibility', 'mobility', 'inflammation'],
    benefits: [
    ...
    supplementFacts: {
      ...
      ingredients: [
        ...
        { name: 'Boswellia (Boswellia serrata) 10:1 Extract', amount: '100 mg' },
        { name: 'Turmeric (Curcuma longa) 10:1 Extract', amount: '50 mg' },
        { name: 'Ginger (Zingiber officinale) 10:1 Extract', amount: '60 mg' },
        { name: 'Shatavari (Asparagus racemosus) 20:1 Extract', amount: '160 mg' },
        { name: 'Ashwagandha (Withania somnifera) 10:1 Extract', amount: '100 mg' },
        ...
        { name: 'Malkangni (Celastrus paniculatus) 10:1 Extract', amount: '80 mg' },
        { name: 'Black Pepper (seed) 10:1 Extract', amount: '10 mg' },
      ],
    },
  },
