...
describe('Blog System Integration', () => {
  describe('BlogSearch Component', () => {
    it('should show search results as user types', async () => {
      ...
      expect(screen.getByText('Learn everything about Ayurvedic medicine')).toBeInTheDocument()
    })
    ...
    it('should clear results when search is cleared', async () => {
      ...
      expect(screen.queryByText('Complete Guide to Ayurveda')).not.toBeInTheDocument()
    })
  ...
  describe('Category and Tag Filtering', () => {
    it('should filter posts by category', () => {
      const ayurvedaPosts = mockPosts.filter(p => p.category === 'ayurveda-basics')
