  ...
  if (variant === 'compact') {
    return (
      <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 text-xs text-neutral-600 mt-8">
        <p>
          <strong>Disclaimer:</strong> These statements have not been evaluated
  ...
  return (
    <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-6 mt-12">
      ...
      <div className="space-y-2 text-sm text-neutral-600">
        <p>
          <strong>FDA Disclaimer:</strong> The statements made regarding these
          products have not been evaluated by the Food and Drug Administration.
          The efficacy of these products has not been confirmed by FDA-approved
          research. These products are not intended to diagnose, treat, cure or
          prevent any disease.
        </p>
        <p>
          All information presented here is not meant as a substitute for or
          alternative to information from healthcare practitioners. Please
          consult your healthcare professional about potential interactions or
