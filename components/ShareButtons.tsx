  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="w-10 h-10 bg-primary-100 hover:bg-primary-200 rounded-full flex items-center justify-center text-primary-600 hover:text-primary-800 transition-all relative"
